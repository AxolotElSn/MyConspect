...
window.addEventListener('DOMContentLoaded', () => {
    ...
    let sex = 'female', 
        height, weight, age, 
        ratio = 1.375 // пол рост вес возраст коэф. атив.
    ...
    function getStaticInformation(parentSelector, activeClass) { // чтоб зеленым выделялся
    ...
    getStaticInformation('#gender', 'calculating__choose-item_active'); // вызов ф-ии для блока с полом
    getStaticInformation('.calculating__choose_big', 'calculating__choose-item_active'); //  вызов ф-ии для блока с дневной активностью
